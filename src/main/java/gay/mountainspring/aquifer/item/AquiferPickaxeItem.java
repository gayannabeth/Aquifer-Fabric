...
/**
 * Extension of the vanilla PickaxeItem class that adds default item break and enchantability components
 */
public class AquiferPickaxeItem extends PickaxeItem {
	public AquiferPickaxeItem(SoundEvent breakSound, ToolMaterial toolMaterial, Settings settings) {
	...
	public AquiferPickaxeItem(ToolMaterial toolMaterial, Settings settings) {
