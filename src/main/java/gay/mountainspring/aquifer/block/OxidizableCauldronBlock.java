...
public class OxidizableCauldronBlock extends AquiferCauldronBlock implements Oxidizable {
	public static final MapCodec<OxidizableCauldronBlock> CODEC = RecordCodecBuilder.mapCodec(
			...
			.apply(instance, OxidizableCauldronBlock::new));
	
	private final Oxidizable.OxidationLevel oxidationLevel;
	
	@Override
	protected MapCodec<OxidizableCauldronBlock> getCodec() {
		return CODEC;
	}
	
	public OxidizableCauldronBlock(Oxidizable.OxidationLevel oxidationLevel, CauldronGroup group, Settings settings) {
